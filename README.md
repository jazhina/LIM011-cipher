...
### UX
?
- [SI-SI-SI] Dise�ar la aplicaci�n pensando y entendiendo al usuario.
- [SI-SI-SI] Crear prototipos para obtener feedback e iterar.
- [SI-SI-SI] Aplicar los principios de dise�o visual (contraste, alineaci�n, jerarqu�a).
?
### HTML y CSS
?
- [SI-SI-SI] Uso correcto de HTML sem�ntico.
- [SI-SI-SI] Uso de selectores de CSS.
- [SI-SI-SI] Construir tu aplicaci�n respetando el dise�o realizado (maquetaci�n).
?
### DOM
?
- [SI-SI-SI] Uso de selectores del DOM.
- [SI-SI-SI] Manejo de eventos del DOM.
- [SI-NO-NO] Manipulaci�n din�mica del DOM.
?
### Javascript
?
- [SI-SI-SI] Manipulaci�n de strings.
- [SI-SI-SI] Uso de condicionales (if-else | switch).
- [SI-SI-SI] Uso de bucles (for | do-while).	
- [SI-SI-NO] Uso de funciones (par�metros | argumentos | valor de retorno).
- [SI-SI-SI] Declaraci�n correcta de variables (const & let).
?
### Testing
- [SI-NO-NO] Testeo de tus funciones.
?
### Git y GitHub
- [NO-NO-NO] Comandos de git (add | commit | pull | status | push).
- [SI-SI-SI] Manejo de repositorios de GitHub (clone | fork | gh-pages).
?
### Buenas pr�cticas de desarrollo
- [NO-NO-NO] Uso de identificadores descriptivos (Nomenclatura | Sem�ntica).
- [SI-SI-SI] Uso de linter para seguir buenas pr�cticas (ESLINT).
